    ...
    <div id="invitateCodeNew">
        <div class="invitateCodeNewBox">
            ...
            <div class="invitateCodeNum clearfix"  v-show="isIvcode">
                <div class="yqmNew_bg"><img src="../../../assets/images/passenger/invitationCode/New/yqmNew_bg.png"></div>
                <div class="invitateCodeBG">
                    <input class="invitateCodeInput fl" v-model="ivcode" placeholder="输入好友邀请码"/>
                    <p class="okbtnNew_icon fl" @click="invitateCodeM()"><img src="../../../assets/images/passenger/invitationCode/New/okbtnNew_icon.png"></p>
                </div>
            </div>
        </div>
  ...
  export default {
    ...
    methods:{
      ...
      InviteFriendsCode(showSrcoll){
        ...
        this.$server.get(this.baseURL+"butterfly-biz/app/v3.0/reward/get-detail",paramsObj,headersObj).then(res =>{
            if( res.data.length > 0 &&  res.data.length != 'undefined'){
                ...
                showSrcoll( this.InviteFriendsData );
            }else {
                this.noData = true;
            }
        });
      ...
      ExclusiveCode(){
        ...
        this.$server.get(this.baseURL+"usercenter-driver/v1.0/passport/select-byprimarykey",paramsObj).then(res =>{
...
<style scoped>
    #invitateCodeNew{overflow-x: hidden;padding-bottom: 3rem;}
    ...
    .yqmNew_bg{width: 100%; height:4.9rem; overflow: hidden;margin-left: -1rem;}
    .yqmNew_bg img{width: 100%;}
    .okbtnNew_icon{width: 32%;margin-left: -1rem;}
    .okbtnNew_icon img{width: 100%;margin-top: -0.2rem;}
    .invitateCodeInput{width: 65%;background: #ffffff;padding-top: 1.3rem;padding-bottom: 1.2rem; padding-left: 20px;outline: none;font-size: 1.3rem}
    .invitateCodeBG{position: absolute;top: 0.5rem; left: 1rem;}
    ...
    .InviteFriendsList{width: 80%;margin: 0 auto; position: relative;
        transition: top 0.5s;}
